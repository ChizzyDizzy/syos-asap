...
<div class="container">
    <div class="welcome">
        ...
        <p>You have full access to all system features. Manage products, sales, reports, and users.</p>
    </div>
    ...
    <div class="dashboard-grid">
        <a href="<%= request.getContextPath() %>/admin/products?action=list" class="dashboard-card">
            ...
            <div class="card-description">Add, edit, delete products. Manage stock levels and pricing.</div>
        </a>
        ...
        <a href="<%= request.getContextPath() %>/sales?action=list" class="dashboard-card">
            ...
            <div class="card-description">Browse all sales transactions and view details.</div>
        </a>

        <a href="<%= request.getContextPath() %>/reports?type=daily-sales" class="dashboard-card">
            <div class="card-icon purple">📈</div>
            <div class="card-title">Sales Reports</div>
            <div class="card-description">Generate daily sales reports with detailed analytics.</div>
        </a>

        <a href="<%= request.getContextPath() %>/reports?type=stock" class="dashboard-card">
            <div class="card-icon teal">📋</div>
            <div class="card-title">Stock Report</div>
            <div class="card-description">View current inventory levels and stock status.</div>
        </a>
        ...
        <a href="<%= request.getContextPath() %>/reports?type=reorder" class="dashboard-card">
            ...
            <div class="card-description">See products that need to be reordered.</div>
        </a>

        <a href="<%= request.getContextPath() %>/admin/users?action=list" class="dashboard-card">
            <div class="card-icon purple">👥</div>
            <div class="card-title">User Management</div>
            <div class="card-description">Manage system users, roles, and permissions.</div>
        </a>

        <a href="<%= request.getContextPath() %>/products?action=list" class="dashboard-card">
            <div class="card-icon blue">🔍</div>
            <div class="card-title">Browse Products</div>
            <div class="card-description">View product catalog and search items.</div>
        </a>
    </div>
</div>
</body>
